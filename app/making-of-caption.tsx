    ...
    <section className="making-of-card" aria-labelledby="making-of-heading">
      <div className="making-of-intro">
        ...
        <span>
          {isPublished
            ? "Published"
            : state.caption?.generationSource === "demo_fixture"
              ? "Mock · GPT-5.6 schema"
              : "GPT-5.6"}
        </span>
      </div>
      ...
      {state.caption && (
        <div className="caption-result">
          {state.caption.generationSource === "demo_fixture" && (
            <p className="demo-caption-notice" role="note">
              <strong>Demo response.</strong> This deterministic caption matches the
              GPT-5.6 output schema, but it was not generated by GPT-5.6.
            </p>
          )}
